...
class CreditRepositoryTest {
    ...
    fun `should find credit by credit code`(){
        // given
        val creditCode1 = UUID.fromString("abd815b5-5943-477d-b453-025cfa6631ea")
        val creditCode2 = UUID.fromString("b71f5c12-f752-42a8-ab18-1ca384462a7d")
    ...
    @Test
    fun `should find all credit by customer is`(){
        // given
        val customerId: Long = 1L
        // when
        val creditList: List<Credit> = creditRepository.findByAllCustomerId(customerId)
        // then
